...
contract MyGovernorTest is Test {
    ...
    uint256 public constant MIN_DELAY = 1; // 1 hour - after a vote passes, you have 1 hour before you can enact
    ...
    function testGovernanceUpdatesBox() public {
        ...
        vm.warp(block.timestamp + VOTING_PERIOD + 5);
        vm.roll(block.number + VOTING_PERIOD + 5);
        ...
        vm.roll(block.number + MIN_DELAY + 10);
